...
<h2 class="text-burgundy dark:text-gray-100 text-sm font-bold tracking-tight text-center uppercase">Ôpadoca Express</h2>
</div>
</div>
...
<p class="text-burgundy/70 dark:text-gray-400 text-sm mt-2">Etapa 1 de 2: Dados básicos da loja</p>
</div>
...
<p class="text-burgundy/60 dark:text-gray-400 text-[10px] mt-0.5">(Tamanho recomendado: 800x400px)</p>
</div>
